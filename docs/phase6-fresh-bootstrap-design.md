...
registered, and the initial window has loaded. If an already-running Electron
...
missing option values return usage. Stable exit codes are: `0` installed,
`10` already installed, `20` repair required, `21` review required, `30` build
