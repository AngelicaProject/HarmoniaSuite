...
@Service
public class AtlasClient implements AtlasInspector {
    ...
    public SourceSnapshotMetadata inspect(Path hxsPath) {
    ...
    private SourceSnapshotMetadata parseInspection(String stdout) {
        ...
        try {
            ...
            return new SourceSnapshotMetadata(hxsVersion, gameVersion, language, scope,
