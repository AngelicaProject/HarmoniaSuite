...
export const ENTRY_STATUS_OPTIONS = Object.freeze([
  ...
  Object.freeze({value: ENTRY_STATUS.NO_TRANSLATION_REQUIRED, label: 'Не требует перевода'}),
  Object.freeze({value: ENTRY_STATUS.MACHINE_TRANSLATED, label: 'Машинный перевод'}),
  Object.freeze({value: ENTRY_STATUS.STALE, label: 'Устарело'}),
  Object.freeze({value: ENTRY_STATUS.HUMAN_REVIEWED, label: 'Проверено человеком'}),
...
export const ENTRY_STATUS_SUMMARY = Object.freeze([
  ...
  Object.freeze({value: ENTRY_STATUS.HUMAN_REVIEWED, label: 'Проверено человеком', dot: 'info'}),
  Object.freeze({value: ENTRY_STATUS.MACHINE_TRANSLATED, label: 'Машинный перевод', dot: 'warn'}),
  Object.freeze({value: ENTRY_STATUS.NO_TRANSLATION_REQUIRED, label: 'Не требует перевода', dot: 'mut'}),
  Object.freeze({value: ENTRY_STATUS.UNTRANSLATED, label: 'Не переведено', dot: 'mut'}),
...
export function isTranslated(entry) {
  return !!entry && (isNoTranslationRequired(entry.status)
