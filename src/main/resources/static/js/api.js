...
export const api={
  ...
  saveSettings:(b)=>req('/api/settings',{method:'PUT',headers:{'Content-Type':'application/json'},body:JSON.stringify({mode:b.mode,game_path:b.gamePath,unpacker_exe:b.unpackerExe,csv_dir:b.csvDir})}),
